...
class Read:
    ...
    def __init__(self):
        ...
        if Mainframe >= 0:
            self.mtext = "Le prix d'ordinateur central a augmenté !\n C'est le moment de le vendre \n mais pas de l'acheter!"
        else:
            self.mtext = "Le prix d'ordinateur central a baissé !\n C'est le moment de le l'acheter \n mais pas de le vendre!"

        if Fennec >= 0:
            self.ftext = "Le prix de la Fennec a augmenté !\n C'est le moment de le vendre \nmais pas de l'acheter!"

        else:
            self.ftext = "Le prix de la Fennec a baissé !\n C'est le moment de le l'acheter \nmais pas de le vendre!"

        if Zomba >= 0:
            self.ztext = "Le prix des Zombas TW a augmenté !\n C'est le moment de le vendre\n mais pas de l'acheter!"
        else:
            self.ztext = "Le prix des Zombas TW a baissé !\n C'est le moment de le l'acheter\n mais pas de le vendre!"
        if Octane >= 0:
            self.otext = "Le prix de la Octane Poupre a augmenté !\n C'est le moment de le vendre\n mais pas de l'acheter!"

        else:
            self.otext = "Le prix de la Octane Poupre a baissé !\n C'est le moment de le l'acheter\n mais pas de le vendre!"

        if Interstellar >= 0:
            self.itext = "Le prix d'interstellar a augmenté !\n C'est le moment de le vendre\n mais pas de l'acheter!"
        else:
            self.itext = "Le prix d'Interstellar a baissé !\n C'est le moment de le l'acheter\n mais pas de le vendre!"
